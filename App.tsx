  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row text-right print:block" dir="rtl">
      ...
      <main className="flex-1 md:mr-64 p-4 md:p-8">
        ...
        {activeTab === 'dashboard' && <TaskDashboard currentUser={currentUser} logs={logs} employees={employees} announcements={announcements} onRefresh={() => window.location.reload()} onStartLogging={() => setActiveTab('daily-log')} onApproveLog={handleApproveLog} onRejectLog={handleRejectLog} onCommitLog={handleCommitLog} onAddAnnouncement={handleAddAnnouncement} />}
